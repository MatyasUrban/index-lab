...
export default function QuizCard({ id }: QuizCardProps) {
    ...
    const learnItem = learningPath.find(item => item.id === id && item.type === "learn") as LearnItem | undefined
    ...
    useEffect(() => {
        if (state === "question" && currentQuestion) {
            const allOptions = [...currentQuestion.incorrect, currentQuestion.correct]
            ...
            <CardContent className="pt-6">
                ...
                {state === "results" && (
                    <div className="text-center py-8">
                        ...
                        <Badge className={correctAnswers === totalQuestions ? "bg-green-600" : "bg-red-600"}>
